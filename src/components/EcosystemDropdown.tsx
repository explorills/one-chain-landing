...
export function EcosystemDropdown() {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {isOpen && (
        <div className="absolute right-0 top-full mt-2 w-52 py-1.5 bg-card border border-border rounded-xl shadow-[0_8px_30px_rgba(0,0,0,0.4),0_0_20px_oklch(0.55_0.23_264/0.1)] backdrop-blur-xl overflow-hidden z-50">
